...
declare module '$env/static/private' {
	...
	export const DIGITAL_OCEAN_API: string;
	...
	export const BRAVE_SEARCH_API_KEYS: string;
	export const EXOPRIORS_API_KEY: string;
